...
import com.ppcc.app.model.jpa.util.JPAUtil;
 ...
 * @author paulones
 */
public class PessoaJuridicaSucessaoHistoricoJpaController implements Serializable {

    public PessoaJuridicaSucessaoHistoricoJpaController() {
    }
